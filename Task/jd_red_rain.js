...
function taskGetUrl(url, body) {
  return {
    ...
    headers: {
      ...
      "Cookie": cookie,
      "User-Agent": "JD4iPhone/9.5.2 CFNetwork/1220.1 Darwin/20.3.0"
    }
  }
}
...
function taskPostUrl(function_id, body = body) {
  return {
    ...
    headers: {
      ...
      'content-type': 'application/x-www-form-urlencoded',
      'accept': '*/*',
      'user-agent': 'JD4iPhone/167650 (iPhone; iOS 14.4.2; Scale/3.00)',
  ...
  return new Promise(async resolve => {
    const options = {
      ...
      "headers": {
        ...
        "User-Agent": $.isNode() ? (process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : "Mozilla/5.0 (iPhone; CPU iPhone OS 14_4_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0.3 Mobile/15E148 Safari/604.1") : ($.getdata('JDUA') ? $.getdata('JDUA') : "Mozilla/5.0 (iPhone; CPU iPhone OS 14_4_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0.3 Mobile/15E148 Safari/604.1")
      }
    }
